  ...
  <div>
        ...
        >
          ...
          <q-item-section class="col items-end">
            <q-btn
              ...
              color="primary"
              label="ADD"
              @click="food.optionFood && food.optionDrink ? optionList(food.optionFood, food.optionDrink): food.optionFood ? optionList(food.optionFood, false): food.optionDrink ? optionList(false, food.optionDrink): add = false; selected = food"
            />
            <div v-else>
              <div class="row justify-center items-center">
                <div class="col">
                  <q-btn
                    ...
                    @click="modificar_cantidad(false,food.id,food,index,indexx)"
                  />
                </div>
                ...
                <div class="col">
                  <q-btn
                    ...
                    icon="add"
                    style="border-radius: 6px; height:23px; width:29px; font-size:8px"
                    @click="modificar_cantidad(true,food.id, food,index,indexx)"
                  />
                </div>
              </div>
            </div>
    ...
    >
      <q-card style="width: 100%; height: 700px">
        <q-list>
          <q-item>
            <q-item-section class="text-h5 text-bold text-grey-7">Select Option</q-item-section>
            <q-item-section class="col items-end">
              <q-btn
                outline
                size="md"
          ...
          <div v-if="optionFood.length">
            <q-item>
              <q-item-section class="text-subtitle2 text bold text-grey-7">Select Item Size</q-item-section>
            </q-item>
            <q-item
              clickable
              tag="label"
            ...
            >
              ...
              <q-item-section class="col column col">
                <q-item-label class="items-end text-subtitle1">₹ {{option.priceOp}}</q-item-label>
              </q-item-section>
            </q-item>
          ...
          <div v-if="optionDrink.length">
            <q-item>
              <q-item-section class="text-subtitle2 text bold text-grey-7">You can also add some addon's</q-item-section>
            </q-item>
            <q-item
              clickable
              tag="label"
